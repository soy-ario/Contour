...
export default function LoginPage() {
  return (
    <div className="flex min-h-screen">
      {/* Left Panel — Branding */}
      <div className="hidden lg:flex w-[45%] relative bg-[#181818] items-center justify-center overflow-hidden">
        {/* Subtle radial gradient */}
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_center,rgba(242,72,90,0.03)_0%,transparent_70%)]" />
          ...
          >
            ...
            <defs>
              <linearGradient id="chartGrad" x1="0" y1="0" x2="0" y2="1">
                <stop offset="0%" stopColor="#F2485A" stopOpacity="0.3" />
                <stop offset="100%" stopColor="#F2485A" stopOpacity="0" />
              </linearGradient>
            </defs>
          </svg>
        </div>
        ...
        <div className="relative z-10 flex flex-col items-center">
          ...
          <div className="absolute w-[120px] h-[120px] rounded-full bg-[#F2485A]/10 blur-[40px] -translate-y-4" />

          {/* Logo */}
          <div className="w-[64px] h-[64px] rounded-[16px] bg-[#F2485A] flex items-center justify-center shadow-lg shadow-[#F2485A]/20">
            <svg
      ...
      <p className="fixed bottom-6 text-[12px] text-[#6B6B80] left-0 right-0 text-center lg:left-[45%] lg:text-center">
        &copy; {new Date().getFullYear()} Contr.studio. All rights reserved.
      </p>
    </div>
  );
}
